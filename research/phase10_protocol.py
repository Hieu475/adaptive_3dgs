...
GATE_CRITERIA_10: Dict[str, Dict[str, Any]] = {
    ...
    "Gate_10B_closed_loop_correctness": {
        "description": "Continuous stateful trajectory S_t -> S_{t+1} across entire sequence. "
                       "No Gaussian state reset between frames.",
        "type": "verification",
        "criteria": [
            "continuous_map_state",
            "no_per_frame_state_reset",
            "all_frames_completed_without_crash",
        ],
    },
    ...
    "Gate_10D_scientific_validity": {
        "description": "Fixed protocol, fixed seeds [42,43,44,45,46], frozen checkpoint, "
                       "test sequence untouched, reproducible logs, zero hidden oracle.",
        "type": "reproducibility",
        "criteria": [
            "fixed_seeds_evaluated",
            "frozen_checkpoint_unaltered",
            "test_sequence_untouched",
            "checksums_and_manifest_generated",
        ],
    },
    "Gate_10E_performance_characterization": {
        "description": "Objective characterization of B2 vs ERROR_ONLY and B2 vs FULL. "
                       "Valid scientific result regardless of whether B2 outperforms or matches baseline.",
        "type": "characterization",
        "criteria": [
            "report_psnr_trajectory",
            "report_delta_q_and_cumulative_q",
            "report_selection_dynamics",
            "report_systems_and_memory_metrics",
            "paired_statistical_testing",
        ],
    },
}
